...
export const api = {
  ...
  /** 导入项目数据（支持三种模式：overwrite 覆盖/new 新建/merge 合并） */
  importProject: (projectData: Record<string, unknown>, mode?: string) =>
    call<string>("import_project", { projectData, mode: mode || "overwrite" }),
